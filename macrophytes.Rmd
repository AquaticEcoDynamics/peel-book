...
knitr::include_graphics("images/macrophytes/picture2.webp")
```
...
knitr::include_graphics("images/macrophytes/picture3.webp")
```
...
knitr::include_graphics("images/macrophytes/picture13.webp")
```
...
::: {.body-text width="100%"}
Data used are available in the Peel ARC Linkage Project Github repository [@busch2023]. SPECIFICALLY THE MAC DATA
:::
