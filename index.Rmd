...
The model and data stes associated with this book are licensed under [Creative Commons CC0 1.0 Universal (CC0 1.0)](https://creativecommons.org/publicdomain/zero/1.0/), i.e. public domain, unless otherwise identified.
...
The work contained herein served to compile a diverse da=ta-set sapnnign many disciplines, decades, and data-types. In the spirit of fostering future continuation of the analyses  
