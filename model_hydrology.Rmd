...
::: {.body-text width="100%"}
Hydrologic features such as water circulation, retention and the pattern of saline water intrusion are critical in shaping estuarine ecosystems and health. The interactions of pulses of freshwater runoff with ocean water inputs can create complex hydrodynamics that subsequently structures the biogeochemical processes, including the distribution of nutrients and hotspots of primary productivity [e.g., @cauwet1994eutrophication; @kasai2010saltwedge; @watanabe2014influence; @cloern2017ecosystem]. In particular, salt intrusion can increase lagoon salinity and drive a difference between surface and bottom salinity (salinity stratification). In highly seasonal systems, like in southern Australia, this effect leads to notable oxygen depletion and establishes hypoxia in the bottom boundary layer [@bruce2014hydrodynamic; @cottingham2014marked; @huang2018assessing], and can raise the likelihood of hypersalinity during the long dry summer and autumn months [@potter2010concept]. More generally, the time-scales associated with water transportation and retention are often related to the long-term trophic state and ensuing phytoplankton dynamics in coastal systems [e.g., @knoppers1991trophic; @ferreira2005does; @paerl2006anthropogenic; @zhu2017effects]. Therefore, understanding and predicting hydrologic changes is critical to underpin our understanding of estuary water quality and approaches to management. 
...
::: {.body-text width="100%"}
Some of the results presented in this chapter were published in Huang et al. (2020), to which readers are also referred.  We thank Dr. Jatin Kala and Dr. Julia Andrys from Murdoch University for providing meteorological data from their Weather Research and Forecasting (WRF) model.
:::
