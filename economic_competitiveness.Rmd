...
Centre for Regional Development, The University of Western Australia, Perth, Australia
:::

```{r economic-competitiveness-pic1, echo = FALSE, out.width='100%', class = "title-image"}

knitr::include_graphics("images/economic_competitiveness/picture1.webp")
