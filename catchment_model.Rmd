...
knitr::include_graphics("images/catchment_model/picture1.png")
...
knitr::include_graphics("images/catchment_model/picture2.png")
...
knitr::include_graphics("images/catchment_model/picture3.png")
...
knitr::include_graphics("images/catchment_model/picture4.png")

```

```{r catchment-model-pic5, echo = FALSE, out.width='100%', class = "text-image", fig.cap = "Reporting catchments for the Peel-Harvey."}

knitr::include_graphics("images/catchment_model/picture5.png")
...
knitr::include_graphics("images/catchment_model/picture6.png")
...
knitr::include_graphics("images/catchment_model/picture7.png")
...
The above land-uses above account for approximately 80% of the nitrogen and phosphorus loads delivered to the Peel-Harvey Estuary. Beef is clearly the largest source of nutrients in the Peel-Harvey catchment. This is primarily due to the large area of beef farming (Fig. 2), its high nutrient surplus rate, poor nutrient-use efficiency (\<10%) and its location on the Swan Coastal Plain (high rainfall and large areas of low PRI soils).
...
knitr::include_graphics("images/catchment_model/picture8.png")
