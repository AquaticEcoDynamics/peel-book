...
```{r fish-ecology-pic2, echo = FALSE, out.width='100%', class = "text-image", fig.cap = "Murdoch fish sampling team Chris Hallett (centre) and Alan Cottingham (left) with Steve Fisher (right) from Peel-Harvey Catchment Council (Photo, S. Meredith, PHCC)."}

knitr::include_graphics("images/fish_ecology/picture2.webp")
...
Scaled metric scores were then combined to produce an index score (0--100) for each sample. Each index score was then compared to threshold values (Table 3), derived statistically from the distributions of all index scores in the training data sets [after @hallett2014quantile]. This enabled the corresponding ecological health grade (A, very good, to E, very poor) to be determined for each sample. Intermediate grades (*e.g.* B/C, good-fair, or C/B, fair-good) were awarded if the sample index score was within one point of a grade threshold.
:::
