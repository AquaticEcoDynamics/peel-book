...
^3^ Centre for Coastal Biogeochemistry, Southern Cross University, Lismore, Australia
:::
...
knitr::include_graphics("images/sediment/picture2.webp")
...
::: {.body-text width="100%"}
Data used are available in the Peel ARC Linkage Project Github repository [@busch2023]. SPECIFICALLY THE SED DATA
:::
